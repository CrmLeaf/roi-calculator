...
In scope: this package, `crmleaf/roi-calculator`.
...
[advisories]: https://github.com/crmleaf/roi-calculator/security/advisories/new
[calc]: https://github.com/crmleaf/roi-calculator/issues/new?template=calculation-error.yml
