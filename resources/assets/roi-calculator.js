/*
 * Progressive enhancement for Payroll ROI Calculator.
 *
...
(function () {
    ...
    var TOOL = 'roi-calculator';
    var CALCULATOR = 'roi';
    var FIELDS = [
        { name: 'employee_count', argument: 'employeeCount', type: 'int' },
        { name: 'hourly_rate', argument: 'hourlyRate', type: 'money' },
        { name: 'hours_per_cycle_manual', argument: 'hoursPerCycleManual', type: 'float' },
        { name: 'cycles_per_year', argument: 'cyclesPerYear', type: 'int' },
        { name: 'software_annual_cost', argument: 'softwareAnnualCost', type: 'money' },
        { name: 'automation_efficiency', argument: 'automationEfficiency', type: 'float' },
        { name: 'penalty_cost_per_year', argument: 'penaltyCostPerYear', type: 'money' },
        { name: 'error_cost_per_year', argument: 'errorCostPerYear', type: 'money' },
    ];
